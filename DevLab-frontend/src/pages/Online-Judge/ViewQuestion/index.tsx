...
import '@umijs/max';
import { Button, Col, Divider, message, Row, Select, Statistic } from 'antd';
          ...
          <Row>
            <Col sm={24} lg={12} span={12}>
              <ProCard
                ...
                extra={[<TagList key={'id'} tags={initData?.tags ?? []} />]}
              >
                ...
                <div>
                  {/*<ReactMarkdown>{initData?.content}</ReactMarkdown>*/}
            ...
            <Col sm={24} lg={12} span={12}>
              ...
              <MargBottom16 />
              <CodeEditor lang={'java'} value={code} onChange={setCode} />
            </Col>
          </Row>
        </ProCard>
      </PageContainer>
